...
public class EditorialServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        switch (action) {
            case "listar" -> listarEditoriales(request, response);
            case "agregar" -> procesarEditorial(request, response, "agregar");
            case "mostrar" -> procesarEditorial(request, response, "mostrar");
            case "actualizar" -> procesarEditorial(request, response, "actualizar");
            case "eliminar" -> procesarEditorial(request, response, "eliminar");
            default -> listarEditoriales(request, response);
        }
    }
